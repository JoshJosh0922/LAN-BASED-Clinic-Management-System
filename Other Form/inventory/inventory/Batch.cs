    ...
    public partial class Batch : Form
    {
        ...
        public void items()
        {
            ...
            if (dt1.Rows.Count > 0)
            {
                ...
                for (int i = 0; i < datacount; i++)
                {
                    ...
                    received.Location = new Point(724, 8);
                    received.Font = new Font("Segoe UI Variable", 10);
                    ...
                    expiry.Location = new Point(1021, 8);
                    ...
                    edit.Location = new Point(1289, 8);
                    ...
                    delete.Location = new Point(1338, 8);
        ...
        public void searchedItem()
        {
            ...
            if (dt.Rows.Count > 0)
            {
                ...
                {
                    code.AutoSize = true;
                    code.Size = new Size(56, 34);
                    code.Location = new Point(26, 8);
                    code.Font = new Font("Segoe UI Variable", 10);
                    code.ForeColor = Color.Black;
        ...
        void delete_click(object sender, EventArgs e)
        {
            ...
            if (dial == DialogResult.Yes)
            {
                ...
                if (dt3.Rows.Count > 0)
                {
                    int count = Convert.ToInt32(dt3.Rows[0]["counts"]);
                    if (count > 0)
                    {
