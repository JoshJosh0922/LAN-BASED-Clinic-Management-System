        ...
        public void items()
        {
            ...
            if (dt1.Rows.Count > 0)
            {
                ...
                for (int i = 0; i < datacount; i++)
                {
                    ...
                    consumed.Location = new Point(878, 10);
                    ...
                    stock.Location = new Point(1051, 10);
                    ...
                    expiry.Location = new Point(1176, 10);
                    ...
                    //btnEdit.Location = new Point(1085, 10);
                    ...
                    //delete.Location = new Point(1129, 10);
