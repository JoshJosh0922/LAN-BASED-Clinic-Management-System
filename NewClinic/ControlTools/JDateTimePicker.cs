...
namespace WindowsFormsApp1.NewFolder1
{
    public class JDateTimePicker : DateTimePicker
    {
        ...
        private Image calendarIcon = NewClinic.Properties.Resources.calendarWhite;
        ...
        public Color SkinColor
        {
            ...
            set
            {
                ...
                if (skinColor.GetBrightness() >= 0.6F)
                    calendarIcon = NewClinic.Properties.Resources.calendarDark;
                else calendarIcon = NewClinic.Properties.Resources.calendarWhite;
                this.Invalidate();
            }
        }
